...
Elusive Shortcodes allow quick and easy implementation of Twitter Bootstrap components through the TinyMCE rich-editor.
...
You must toggle the Advanced Editor Toolbar to unlock the Elusive Shortcodes icons. (see screenshot)

== Screenshots ==

1. The rendered Bootstrap components as they would appear with a default Bootstrap 3 theme.
2. Enable the Elusive Shortcodes icons by toggling the Advanced Editor Toolbar.
