  ...
  <fieldset class="form-horizontal step-fields">
    <div class="form-group">
      ...
      <div class="col-xs-12 col-sm-4 col-md-4">
        ...
        <input type="text" class="form-control" name="borrows[first_name]" id="borrows-first-name" />
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
    ...
    <div class="form-group">
      <div class="col-xs-12 col-sm-4 col-md-4">
        ...
        <div class='input-group date-picker bs-date' id='date-picker-dob'>
          <input type='text' class="form-control bs-date-ddmmyyy" placeholder="DD / MM / YYYY" name="borrows[date_of_birth]" id="borrows-date-of-birth" />
          <span class="input-group-addon">
            <span class="fa fa-calendar"></span>
          </span>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-sm-offset-right-4 col-md-4 col-md-offset-right-4">
    ...
    <div class="form-group">
      <div class="col-xs-12 col-sm-8 col-md-8">
        ...
        <textarea class="form-control" rows="3" name="borrows[current_address]" id="borrows-current-address"></textarea>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
